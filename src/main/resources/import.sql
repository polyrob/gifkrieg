...
insert into user (active, email, password, username) values (5, "user5@gmail.com", "$2a$10$dUeWB1H9Zj78c.fQiQi1mOAmbJyvZc7NmMLW6lRNCpcJzU41puam2", "user5")
insert into user_role (user_id, role_id) values (7, 1)

insert into user (active, email, password, username) values (5, "user6@gmail.com", "$2a$10$dUeWB1H9Zj78c.fQiQi1mOAmbJyvZc7NmMLW6lRNCpcJzU41puam2", "user6")
insert into user_role (user_id, role_id) values (8, 1)

insert into user (active, email, password, username) values (5, "user7@gmail.com", "$2a$10$dUeWB1H9Zj78c.fQiQi1mOAmbJyvZc7NmMLW6lRNCpcJzU41puam2", "user7")
insert into user_role (user_id, role_id) values (9, 1)

insert into user (active, email, password, username) values (5, "user8@gmail.com", "$2a$10$dUeWB1H9Zj78c.fQiQi1mOAmbJyvZc7NmMLW6lRNCpcJzU41puam2", "user8")
insert into user_role (user_id, role_id) values (10, 1)


-- Create some challenges
insert into challenge (state, card_text, start_time, end_time) values (4, "First Challenge Ever", "2017-04-01 00:00:00", "2017-04-02 00:00:00")
insert into challenge (state, card_text, start_time, end_time) values (4, "Oh great. It's Monday.", "2017-04-02 00:00:00", "2017-04-03 00:00:00")
insert into challenge (state, card_text, start_time, end_time) values (4, "You keep whiping your butt and there's still poop", "2017-04-03 00:00:00", "2017-04-04 00:00:00")
